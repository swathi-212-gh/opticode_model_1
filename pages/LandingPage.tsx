    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white overflow-x-hidden">
      ...
      <nav className="relative z-10 flex items-center justify-between px-8 py-6 max-w-7xl mx-auto">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xl font-bold tracking-tight">OptiCode AI</span>
        </div>
      ...
      <section className="relative z-10 pt-20 pb-32 px-6 text-center max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <button className="w-full sm:w-auto px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-2xl font-bold text-lg transition-all">Quick Demo</button>
        </div>
      </section>
      ...
      <section className="relative z-10 py-24 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="p-8 bg-gradient-to-br from-gray-900 to-[#111] border border-gray-800 rounded-[32px] group hover:border-blue-500/30 transition-all">
            ...
            <p className="text-gray-400 leading-relaxed mb-6">Swaps inefficient loops for built-in high-performance C-extensions like math or sets.</p>
