    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="text-center mb-8 animate-in fade-in slide-in-from-top-4 duration-700">
          ...
          <p className="text-gray-500 font-medium">Standalone Demonstration Platform</p>
        </div>
        ...
        <div className="bg-[#111]/80 border border-white/5 p-8 rounded-[40px] shadow-2xl backdrop-blur-2xl animate-in fade-in zoom-in-95 duration-500">
          <form onSubmit={(e) => handleAuth(e)} className="space-y-5">
            ...
            >
              {loading ? 'Entering System...' : isSignup ? 'Create Account' : 'Sign In'}
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs uppercase"><span className="bg-[#111] px-4 text-gray-600 font-bold">Or use Demo Access</span></div>
          </div>

          <button
            onClick={() => handleAuth(undefined, 'Guest Presenter')}
            disabled={loading}
            className="w-full bg-white/5 hover:bg-white/10 border border-white/10 text-gray-300 font-bold py-4 rounded-2xl transition-all flex items-center justify-center gap-2 group"
          >
